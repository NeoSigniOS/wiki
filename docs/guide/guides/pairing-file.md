...
idevice pair allows us to create a pairing file for programs like Feather-idevice to talk to your device remotely. This is required to use these apps, otherwise they will not function.
:::info
